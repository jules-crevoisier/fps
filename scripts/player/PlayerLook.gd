...
## "joueurs en couleur") — outfit/gear/skin/accent gardent la couleur peinte
...
func _apply_character_materials(mesh: MeshInstance3D, ally: bool) -> void:
	...
	# charge de l'appelant (voir sa docstring). Rien pour un allié (jamais eu
	# de rim, seulement l'encre qui s'amenuise avec la distance).
	if is_enemy:
