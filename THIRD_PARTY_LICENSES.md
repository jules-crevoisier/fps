...
| Bibliothèque de props Cargo Ship (conteneurs, coque, grue, passerelle, bittes, cabestans...) — carte Cargo Ship supprimée (nettoyage du prototype 2026-09-26), mais props ENCORE référencés par le mécanisme générique d'alias de `PropCatalog.gd` (`tests/maps/test_propcatalog.gd`) | `assets/models/props/cargo_ship/*.glb` | `tools/blender/make_props.py` (jeu `SET_CARGO`, DSL `PROPS`) | Œuvre originale du projet (générée par script du dépôt) | — |
